...
class BadmintonPlayerTeamFightsBulk
{
    ...
    public function __invoke($root, array $args, GraphQLContext $context, ResolveInfo $resolveInfo)
    {
        ...
        foreach ($args['input'] as $arg){
            $clubId = $arg['clubId'];
            $season = $arg['season'];
            $ageGroupId = $arg['ageGroupId'];
            $leagueGroupId = $arg['leagueGroupId'];
            $clubName = $arg['clubName'];

            $results = array_merge($this->scraper->getTeamFights($season, $clubId, $ageGroupId, $leagueGroupId, $clubName), $results);
        }
