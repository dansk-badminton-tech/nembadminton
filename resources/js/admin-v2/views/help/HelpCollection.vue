<template>
    <section class="help-page">
        ...
        <div v-if="items.length" class="help-list">
            <router-link v-for="item in items" :key="item.slug" :to="`${basePath}/${item.slug}`" class="help-list__item" :class="{'help-list__item--dated': item.published}">
...
.help-list__item--dated { grid-template-columns: 9rem 1fr auto; }
...
@media (max-width: 640px) {
    .help-list__item--dated { grid-template-columns: 1fr auto; }
