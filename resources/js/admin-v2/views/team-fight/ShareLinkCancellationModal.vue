<template>
    <div class="card">
        <div class="card-content">
            <div class="content">
                <p>Alle som har linket kan melde afbud til denne holdrunde. Spillerne bliver automatisk markeret som afbud og kan ses under "Vis afbud"</p>
                <pre>{{ shareUrl }}</pre>
            </div>
        </div>
...
export default {
    name: "ShareLinkCancellationModal",
    props: ['teamId'],
    data(){
        return {
            showShareLink: false
    ...
    computed: {
        shareUrl(){
            ...
            return getUrl.protocol + "//" + getUrl.host + "/" + getUrl.pathname.split('/')[1] + "/team-fight/" + this.teamId + '/public-cancellation';
        }
    },
    methods: {
        copyToClipboard() {
