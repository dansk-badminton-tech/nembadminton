...
/* harmony import */ var _home_daniel_projects_Vue_Draggable_node_modules_babel_runtime_corejs2_core_js_object_create__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("4aa6");
/* harmony import */ var _home_daniel_projects_Vue_Draggable_node_modules_babel_runtime_corejs2_core_js_object_create__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_home_daniel_projects_Vue_Draggable_node_modules_babel_runtime_corejs2_core_js_object_create__WEBPACK_IMPORTED_MODULE_1__);
...
function cached(fn) {
  var cache = _home_daniel_projects_Vue_Draggable_node_modules_babel_runtime_corejs2_core_js_object_create__WEBPACK_IMPORTED_MODULE_1___default()(null);
  ...
  methods: {
    ...
    onDragAdd: function onDragAdd(evt) {
      ...
      if (this.swap) {
        ...
        var _newIndex = this.getVmIndex(evt.newIndex);
    ...
    onDragRemove: function onDragRemove(evt) {
      if (this.swap) {
        ...
        var _oldIndex = this.context.index;
        this.spliceList(_oldIndex, 1);
        var removed = {
          element: this.context.element,
          oldIndex: _oldIndex
        };
        this.resetTransitionData(_oldIndex);
        this.emitChanges({
          removed: removed
        });
      }
    ...
    onDragUpdate: function onDragUpdate(evt) {
      if (this.swap) {
        ...
        Object(helper["d" /* removeNode */])(evt.item);
        Object(helper["c" /* insertNodeAt */])(evt.from, evt.item, evt.oldIndex);
        var _oldIndex2 = this.context.index;

        var _newIndex2 = this.getVmIndex(evt.newIndex);

        this.updatePosition(_oldIndex2, _newIndex2);
        var moved = {
          element: this.context.element,
          oldIndex: _oldIndex2,
          newIndex: _newIndex2
