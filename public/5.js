    ...
    [
      ...
      _c(
        ...
        [
          _c(
            "b-navbar-item",
            { attrs: { to: { path: "/my-club" }, tag: "router-link" } },
            [
              _c("b-icon", { attrs: { icon: "hand-rock" } }),
              _vm._v(" "),
              _c("span", { staticClass: "nav-item-span" }, [_vm._v("Min klub")])
            ],
            1
          ),
          _vm._v(" "),
          ...
          _c(
            "b-navbar-item",
            {
              attrs: { to: { path: "/team-fight/check" }, tag: "router-link" }
            },
            [
              _c("b-icon", { attrs: { icon: "hand-rock" } }),
              _vm._v(" "),
              _c("span", { staticClass: "nav-item-span" }, [
                _vm._v("Tjek holdkamp")
              ])
            ],
            1
          )
